...
gg.setVisible(false) 
    ...
    "╔══════════ 🦋══════════╗\nꕤ 🎑          کۆدی کۆبۆنەکان          ꕤ\n╚══════════════════════╝",
"╔══════════ 🦋══════════╗\nꕤ 🌝          هەموو ئیمۆیەکان          ꕤ\n╚══════════════════════╝",
"╔══════════ 🦋══════════╗\nꕤ 🖼️     زیادکردنی خاڵی چوارچێوە     ꕤ\n╚══════════════════════╝",
"╔══════════ 🦋══════════╗\nꕤ 🏅          قاڵبە ئاڵتونی کان          ꕤ\n╚══════════════════════╝",
"╔══════════ 🦋══════════╗\nꕤ 🧨        پێداویستیەکانی کاندی        ꕤ\n╚══════════════════════╝",
"╔══════════ 🦋══════════╗\nꕤ 🏠        پێداویستیەکانی کۆگا        ꕤ\n╚══════════════════════╝",
"╔══════════ 🦋══════════╗\nꕤ 🏔️        کۆدەکانی کانە بەردەکە        ꕤ\n╚══════════════════════╝",
"╔══════════ 🦋══════════╗\nꕤ 🔶        کۆدەکانی گەوهەرەکان        ꕤ\n╚══════════════════════╝",
"╔══════════ 🦋══════════╗\nꕤ 👷‍♀️       کۆدەکانی کردنەوەی بیناکان       ꕤ\n╚══════════════════════╝",
"╔══════════ 🦋══════════╗\nꕤ 🎅       کۆدەکانی وێنەی پڕۆفایل       ꕤ\n╚══════════════════════╝",
"╔══════════ 🦋══════════╗\nꕤ 🏕️        کۆمەڵێک جوانکاری یاری        ꕤ\n╚══════════════════════╝",
"╔══════════ 🦋══════════╗\nꕤ 🐔     کۆدەکانی گۆڕینی شێوەی ئاژەڵەکان     ꕤ\n╚══════════════════════╝",
"╔══════════ 🦋══════════╗\nꕤ 🛩️       شەمەندەفەر + بەندەر + فڕۆکە       ꕤ\n╚══════════════════════╝",
"╔══════════ 🦋══════════╗\nꕤ 🏅      کۆدەکانی ژمارەی ناونیشانەکان      ꕤ\n╚══════════════════════╝",
"╔══════════ 🦋══════════╗\nꕤ 🗽      کۆدەکانی دیکۆری پەیکەرەکان      ꕤ\n╚══════════════════════╝",
"╔══════════ 🦋══════════╗\nꕤ 🔰        کۆدەکانی لۆگۆی کەسی        ꕤ\n╚══════════════════════╝",
"╔══════════ 🦋══════════╗\nꕤ 🔄              گەڕانەوە              ꕤ\n╚══════════════════════╝",
"╔══════════ 🦋══════════╗\nꕤ 🚪              دەرچوون              ꕤ\n╚══════════════════════╝",
...
gg.setRanges(gg.REGION_C_ALLOC | gg.REGION_OTHER)
    ...
    gg.alert("😈🇸 🇭 🇪 🇽  🇦 🇷 🇦 🇲 😈\n\n\n✅ گۆڕینی دیاری 29 بەسەرکەوتوویی ئەنجامدرا ✅\n\n🔥 گۆڵد پاس بکەرەوە و دیاری 29 وەربگرە 🔥\n\n\n🌹 ━━━ سەرکەوتووبن ━━━ 🌹")
end
...
function Final_Auto_Collector()
    ...
    local results = gg.getResults(1)
    if #results == 0 then return gg.alert("❌ هیچ ئەنجامێک نەدۆزرایەوە ❌\n\nتکایە دڵنیابە لە بەستنەوەی یاری بە سکریپتەکە ✅\n\nسەیری بەشی نیطاقات الذاكره بکە و دڵنیابە لە چالاککردنی خانەی CA لەگەڵ خانەی بطيء 🔥") end
...
function Run_Hearts_Bears()
    ...
    if #results == 0 then 
        gg.setVisible(true)
        return gg.alert("❌ هیچ ئەنجامێک نەدۆزرایەوە ❌\n\nتکایە دڵنیابە لە بەستنەوەی یاری بە سکریپتەکە ✅\n\nسەیری بەشی نیطاقات الذاكره بکە و دڵنیابە لە چالاککردنی خانەی CA لەگەڵ خانەی بطيء 🔥")
    end
...
function Slemani_InitialSetup(mode)
    ...
    if #res1 == 0 then gg.alert("❌ هیچ ئەنجامێک نەدۆزرایەوە ❌\n\nتکایە دڵنیابە لە بەستنەوەی یاری بە سکریپتەکە ✅\n\nسەیری بەشی نیطاقات الذاكره بکە و دڵنیابە لە چالاککردنی خانەی CA لەگەڵ خانەی بطيء 🔥"); return false end
    ...
    if #res2 == 0 then gg.alert("❌ هیچ ئەنجامێک نەدۆزرایەوە ❌\n\nتکایە دڵنیابە لە بەستنەوەی یاری بە سکریپتەکە ✅\n\nسەیری بەشی نیطاقات الذاكره بکە و دڵنیابە لە چالاککردنی خانەی CA لەگەڵ خانەی بطيء 🔥"); return false end
...
if #results > 0 then
    ...
    gg.alert("😈🇸 🇭 🇪 🇽  🇦 🇷 🇦 🇲 😈\n\n\n✅ گۆڕینی دیاری 29 بەسەرکەوتوویی ئەنجامدرا ✅\n\n🔥 گۆڵد پاس بکەرەوە و دیاری 29 وەربگرە 🔥\n\n\n🌹 ━━━ سەرکەوتووبن ━━━ 🌹")
       ...
       gg.alert("❌ هیچ ئەنجامێک نەدۆزرا٩یەوە ❌\n\nتکایە دڵنیابە لە بەستنەوەی یاری بە سکریپتەکە ✅\n\nسەیری بەشی نیطاقات الذاكره بکە و دڵنیابە لە چالاککردنی خانەی CA لەگەڵ خانەی بطيء 🔥")
end
end
...
function talbganm()
    ...
    local input = gg.prompt(
        {"ژمارەی داواکاریی گەنمەکە بنووسە. 🌾📋"},
        {1000},
        {"number"}
    )
    ...
    gg.toast("🌾✨ ئێستا دەتوانیت گەنم لە کڵانەکە داوا بکەیت 🤝🌾")
    gg.clearResults()
end
