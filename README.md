...
function jalalhh()
    ...
    -- بەشی یەکەم: دروستکردنی ناونیشانەکان بە +384
    local saved = {}
    ...
    --------------------------------------------------
    -- بەشی دووەم: کەمکردنەوەی 16 لە ناونیشانەکان بەبێ تێکدانی Saved List
    --------------------------------------------------
    local minus16 = {}
    for i, v in ipairs(results) do
        minus16[#minus16 + 1] = {
            address = v.address + 384 - 16,
            flags = gg.TYPE_DWORD
        }
    end
    ...
    --------------------------------------------------
    -- بەشی سێیەم: گۆڕینی هەموو ئەنجامەکان بۆ 6
    --------------------------------------------------
    gg.editAll("6", gg.TYPE_DWORD)
    
    -- پاککردنەوەی النتائج لە کۆتاییدا بۆ ئەوەی خاوێن بمێنێتەوە
    gg.clearResults()
